...
if __name__ == '__main__':
    ...
    parser.add_argument('--segments_times', nargs='+', type=int, default=[10], help='in seconds')
    parser.add_argument('--segments_overlaps', nargs='+', type=float, default=[0.75], help='percentage in [0,1]')
    parser.add_argument('--decision_times', nargs='+', type=int, default=[4 * 60], help='in seconds')
